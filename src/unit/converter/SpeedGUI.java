...
public class SpeedGUI extends javax.swing.JFrame {
    ...
    private Image setIcon(){
        return getToolkit().getImage(getClass().getResource("/resources/speed.png"));
    }
    ...
    public void update(){
        if (!inputQuantity.getText().equals(""))
        {
            ...
            SpeedConverter sc = new SpeedConverter(inputType, outputType, input);
            outputQuantity.setText(Double.toString(sc.convert()));
        }
    }
    ...
    private void initComponents() {
        ...
        sourceDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kilometer/hour(km/h)", "mile/hour(mi/h)", "meter/second(m/s)", "knot(kt,kn)" }));
        ...
        destDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "kilometer/hour(km/h)", "mile/hour(mi/h)", "meter/second(m/s)", "knot(kt,kn)" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpeedGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
