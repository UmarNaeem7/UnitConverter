...
public class TimeGUI extends javax.swing.JFrame {
    ...
    private Image setIcon(){
        return getToolkit().getImage(getClass().getResource("/resources/time.png"));
    }
    ...
    public void update(){
        if (!inputQuantity.getText().equals(""))
        {
            ...
            TimeConverter tc = new TimeConverter(inputType, outputType, input);
    ...
    private void initComponents() {
        ...
        sourceDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "second(s)", "minute(min)", "hour(hr)", "day(d)", "week(week)", "month(month)", "year(y)" }));
        ...
        destDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "second(s)", "minute(min)", "hour(hr)", "day(d)", "week(week)", "month(month)", "year(y)" }));
