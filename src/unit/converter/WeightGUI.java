...
public class WeightGUI extends javax.swing.JFrame {
    ...
    private Image setIcon(){
        return getToolkit().getImage(getClass().getResource("/resources/weight.png"));
    }
    ...
    public void update(){
        if (!inputQuantity.getText().equals(""))
        {
            ...
            WeightConverter wc = new WeightConverter(inputType, outputType, input);
            outputQuantity.setText(Double.toString(wc.convert()));
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        sourceDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "gram(g)", "kilogram(kg)", "pound(lb)", "ounce(oz)", "carat(car,ct)" }));
        ...
        destDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "gram(g)", "kilogram(kg)", "pound(lb)", "ounce(oz)", "carat(car,ct)" }));
